...
* el factor multiplicativo, entonces la hipoteca se rechaza. En Tetimo el factor
* multiplicativo es de 5,85. Por ejemplo, si un cliente gana al año 30000 pavos,
* no podría pedir más de 30000*5,85.
* 
Si el cliente ha pasado el filtro de edad y el filtro de la cantidad a solicitar
* , el programa le solicita el número de años en los que quiere devolver 
